...
function PlayerControls() {
  ...
  useEffect(() => {
    if (play === true) audioele.current.play();
    else audioele.current.pause();
  }, [play]);
    ...
    <div className="d-flex justify-content-between py-2">
      ...
      <div style={{ width: "100%", margin: "5px" }}>
        ...
        <div
          ...
          <div>
            <p style={{ margin: "5px 15px 15px 0px" }}>
              {(currtime / 60).toFixed(2)}
            </p>
          </div>
          <Slider
            draggable
          ...
          />
          <div>
            <p style={{ margin: "5px 0px 15px 7px" }}>
              {(currduration / 60).toFixed(2)}
            </p>
          </div>
        </div>
      </div>
